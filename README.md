# term.js + dockerode + express + socket

Connect to the container bash on the backend from frontend web app.
...
gulp webpack // gulp build
```

### Run expressjs server with static resource and socket 

```sh
npm start // or node demo/app.js
